...
//    prompt('Введіть номер пункту\n1. Веселий\n2. Сумний\n3. Обурений', '')
// )

// if (enteredNum < 1 || enteredNum > 3) alert('Некоректний номер')
// else if (enteredNum === 1) alert(':)')
// else if (enteredNum === 2) alert(':(')
// else alert('>:(')
...
// if (diceResult % 2 === 0) scoreUserOne += diceResult
...
//    if (diceResult % 2 === 0) scoreUserOne += diceResult
//    else scoreUserOne -= diceResult

//    if (Math.sign(scoreUserOne) === -1) scoreUserOne = 0
...
// if (diceResult % 2 === 0) scoreUserTwo += diceResult
...
//    if (diceResult % 2 === 0) scoreUserTwo += diceResult
//    else scoreUserTwo -= diceResult

//    if (Math.sign(scoreUserTwo) === -1) scoreUserTwo = 0
...
// const num4 = parseInt(prompt('Введіть четверте число'))
...
// if (num4 > max1 || num3 > max2)
// 	if (max1 < max2)
// 		max1 = num4
// 	else max2 = num4

// document.write(max1, max2)
